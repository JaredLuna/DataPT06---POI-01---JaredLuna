...
def load_and_clean():
    ...
    return Output_steam_df, Australian_items_df, Australian_Items_Expanded_df, Australian_Reviews_df, Australian_Reviews_Expanded_df, df_reviews
...
def PlayTimeGenre(genero: str):
    ...
    Output_steam_df, Australian_items_df, Australian_Items_Expanded_df, Australian_Reviews_df, Australian_Reviews_Expanded_df, df_reviews = load_and_clean()
...
def UserForGenre(genero: str):
    ...
    #Para traer los datos para las querys
    Output_steam_df, Australian_items_df, Australian_Items_Expanded_df, Australian_Reviews_df, Australian_Reviews_Expanded_df, df_reviews = load_and_clean()
    ...
    anios = []
    contador = 1
    for i in clasificacion_anual:
        if contador % 2 == 1:
            anios.append('Año: '+str(i))
        if contador % 2 == 0:
            anios.append('Horas: '+str(i))   
        contador += 1 
    return {f'El usuario con mas horas jugadas para el genero {genero} es {Id_final_user}, Horas jugadas: {anios} '}
...
def UsersRecommend(anio: int):
    ...
    dicto_juegos = {
        'Puesto 1:' : top3_nombres[0],
        'Puesto 2:' : top3_nombres[1],
        'Puesto 3:' : top3_nombres[2]
    }
    return {f'El top 3 de juegos MAS recomendados es: {dicto_juegos}'}
...
def UsersNotRecommend(anio: int):
    ...
    return {f'El top 3 de juegos MENOS recomendados es: {dicto_juegos}'}